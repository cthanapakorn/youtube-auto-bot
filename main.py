...
# --- ⚙️ การตั้งค่าระดับสูงสุด (20 ฉาก x 3 วินาที = 60 วินาทีเป๊ะ) ---
SCENE_COUNT = 20   
SCENE_DURATION = 3 
...
def get_font_family_name(path):
    """แคะชื่อฟอนต์จากไฟล์เพื่อความแม่นยำในการแสดงผลซับไทย"""
    try:
        ...
        print(f"⚠️ ดึงชื่อฟอนต์ไม่ได้: {e}")
        return "Sans"
...
def run_workflow():
    try:
        ...
        print("🧠 1. Gemini กำลังร่างบทเล่าเรื่อง 60 วินาทีและข้อมูล SEO...")
        prompt_sys = (
            "จงสวมบทบาทเป็น Storyteller การเงินระดับโลก หัวข้อ: 'ทำไมคนรวยถึงรวยขึ้น? ความลับที่คน 1% ปกปิดไว้' "
            "สร้างสคริปต์ 20 ท่อน (ท่อนละ 3 วินาที) ที่เล่าเรื่องได้น่าติดตามและสรุปจบใน 60 วินาที "
            "1. บทพากย์ (text): ภาษาไทยธรรมชาติ มีจังหวะหยุดพัก '...' และเน้นเสียง '!' (ต้องยาวประมาณ 20-25 คำเพื่อให้พอดี 3 วินาที)\n"
            "2. คำสั่งวาดรูป (prompt): ภาษาอังกฤษที่อธิบาย 'เหตุการณ์และอารมณ์' สลับภาพตัวละครและสัญลักษณ์ให้หลากหลาย\n"
            "3. ซับไตเติล (caption): คำไทยสั้นๆ 1-2 คำ ให้เด้งขึ้นมาทีละตัวตามจังหวะพูด\n"
        ...
        font_family = get_font_family_name("font.ttf")
        ...
        # 📌 FFmpeg: ผสมเสียงพากย์ + เพลงประกอบ (8%) + ซูม Cinematic + ล็อกเวลา 60 วิ
